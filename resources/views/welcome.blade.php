...
<div class="mt-8 flex justify-center">
    <div name="content" class="sm:w-1 md:w-1/2">
        ...
        <div class="mt-12">
            <p>OpenIRM is a cyber Governance, Risk, and Compliance web application intended for use
            ...
            <p class="mt-6">Above all, OpenIRM is written to solve cyber compliance headaches that tend to be
